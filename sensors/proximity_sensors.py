...
class ProximitySensor(Perception):
    ...
    def sensor(self):
        ...
        sensor_l_pos = [(robot_position_x+(sensor_1_direction_x_l*35)),
                   (robot_position_y+(sensor_1_direction_y_l*35))]
        sensor_r_pos= [(robot_position_x+(sensor_2_direction_x_r*35)),
                  (robot_position_y+(sensor_2_direction_y_r*35))]
        sensor_m_pos = [(robot_position_x+(sensor_3_direction_x_m*35)),
                  (robot_position_y+(sensor_3_direction_y_m*35))]
